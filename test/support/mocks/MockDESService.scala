...
trait MockDESService extends MockFactory {

  protected val mockDESService: DESService = mock[DESService]
  ...
  def mockRemoveCustomerOverride(userData: StateBenefitsUserData,
    ...
    (mockDESService.removeCustomerOverride(_: StateBenefitsUserData)(_: HeaderCarrier))
      .expects(userData, *)
