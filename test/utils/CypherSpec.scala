...
class CypherSpec extends UnitTest
  ...
  "stringCypher" should {
    ...
    "decrypt to string values" in {
      (aesGcmAdCrypto.decrypt(_: String, _: String)(_: String))
        .expects(encryptedValue.value, encryptedValue.nonce, associatedText).returning(stringValue)
  ...
  "booleanCypher" should {
    ...
    "decrypt to boolean values" in {
      (aesGcmAdCrypto.decrypt(_: String, _: String)(_: String))
        .expects(encryptedValue.value, encryptedValue.nonce, associatedText).returning(someBoolean.toString)
  ...
  "bigDecimalCypher" should {
    ...
    "decrypt to BigDecimal values" in {
      (aesGcmAdCrypto.decrypt(_: String, _: String)(_: String))
        .expects(encryptedValue.value, encryptedValue.nonce, associatedText).returning(bigDecimalValue.toString)
  ...
  "uuidCypher" should {
    ...
    "decrypt to UUID values" in {
      (aesGcmAdCrypto.decrypt(_: String, _: String)(_: String))
        .expects(encryptedValue.value, encryptedValue.nonce, associatedText).returning(uuidValue.toString)
  ...
  "localDateCypher" should {
    ...
    "decrypt to LocalDate values" in {
      (aesGcmAdCrypto.decrypt(_: String, _: String)(_: String))
        .expects(encryptedValue.value, encryptedValue.nonce, associatedText).returning(localDateValue.toString)
  ...
  "instantCypher" should {
    ...
    "decrypt to LocalDate values" in {
      (aesGcmAdCrypto.decrypt(_: String, _: String)(_: String))
        .expects(encryptedValue.value, encryptedValue.nonce, associatedText).returning(instantValue.toString)
